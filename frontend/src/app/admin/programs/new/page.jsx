...
import { adminCreateProgram } from "../../../../utils/api";
...
export default function NewProgramPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Auto-generate link from slug if not provided
      if (!formData.link && formData.slug) {
        formData.link = `/programs/${formData.slug}`;
      }

      await adminCreateProgram(formData);
      router.push("/admin");
    } catch (err) {
